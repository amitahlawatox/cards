...
export const OCCASIONS: Occasion[] = [
  ...
  // ── GRADUATION ──────────────────────────────────────────────────
  {
    ...
    tags: ['graduation party', 'grad invite', 'graduation class', 'high school graduation'],
    searches: 280000,
    templates: [
      { id: 'grad-gold',    name: 'Gold & Navy',   bg: 'linear-gradient(135deg,#1e3a8a,#1e40af)', pattern: STAR_PATTERN, textColor: '#fbbf24', accentColor: '#f59e0b', defaultHeading: "Class of [Year] 🎓", defaultBody: "Please join us as we celebrate\n[Name]'s Graduation", defaultFooter: "Hosted by [Family Name]", defaultDate: "[Date]", defaultTime: "[Time]", defaultVenue: "[Venue]" },
      ...
      { id: 'grad-maroon',  name: 'Classic Maroon', bg: 'linear-gradient(135deg,#7f1d1d,#991b1b)', pattern: DOT_PATTERN, textColor: '#fef2f2', accentColor: '#fca5a5', defaultHeading: "Commencement [Year]", defaultBody: "[Name]\nhas completed [Degree]\nfrom [University]", defaultFooter: "Reception to follow", defaultDate: "[Date]", defaultTime: "[Time]", defaultVenue: "[Venue]" },
      { id: 'grad-minimal', name: 'Minimalist',    bg: '#ffffff', textColor: '#111827', accentColor: '#374151', defaultHeading: "[Name]", defaultBody: "Class of [Year]\n[School / University]", defaultFooter: "Graduation Party · [Date]", defaultDate: "[Date]", defaultTime: "[Time]", defaultVenue: "[Location]" },
